---
title: 'Configuration'
description: 'Complete configuration reference for apilens'
---
...
|----------|-------------|---------|
| `POSTGRES_DB` | Database name | `apilens` |
| `POSTGRES_USER` | Database user | `apilens` |
...
| `CLICKHOUSE_DB` | Database name | `apilens` |
...
```bash
# =============================================================================
# apilens Production Configuration
# =============================================================================
