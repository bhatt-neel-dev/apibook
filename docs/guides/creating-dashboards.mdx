...
```bash
curl -X POST https://api.apilens.in/v1/dashboards/ \
...
```bash
curl -X POST https://api.apilens.in/v1/dashboards/dash_123/share/ \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{"public": true}'
```
...
```bash
# Export
curl https://api.apilens.in/v1/dashboards/dash_123/export/ \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -o dashboard.json

# Import
curl -X POST https://api.apilens.in/v1/dashboards/import/ \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d @dashboard.json
```
