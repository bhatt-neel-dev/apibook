---
title: 'Quickstart'
description: 'Get apilens running in under 5 minutes'
---

# Quickstart Guide

Get apilens up and running quickly using Docker.
...
<Note>
  The quickstart script creates a default admin user with email `admin@apilens.local` and password `admin`. **Change this immediately in production!**
</Note>
