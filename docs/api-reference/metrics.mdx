...
<CodeGroup>
```bash cURL
curl -X POST https://api.apilens.in/v1/metrics/ \
...
<CodeGroup>
```bash cURL
curl -X POST https://api.apilens.in/v1/metrics/batch/ \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "metrics": [
...
<CodeGroup>
```bash cURL
curl -G "https://api.apilens.in/v1/metrics/query/" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```bash
curl -G "https://api.apilens.in/v1/metrics/names/" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -G "https://api.apilens.in/v1/metrics/tags/" \
  -H "Authorization: Bearer YOUR_API_KEY" \
